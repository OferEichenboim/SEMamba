                ...
                if steps % cfg['env_setting']['validation_interval'] == 0 and steps != 0:
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            ...
                            mag_g = generator(noisy_mag.to(device))
                            mag_g = torch.exp(mag_g) - 1
...
def main():
    ...
    parser.add_argument('--exp_name', default='SEMamba_basic')
    parser.add_argument('--config', default='recipes/SEMamba_basic/SEMamba_basic.yaml')
